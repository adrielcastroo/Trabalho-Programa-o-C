...
* [**Questão 06 - Cadastro de Usuário**](Questao 06 - Cadastro de Usuário/questao_06.c)**:** Manipulação de vetores de strings para captura e amostragem de dados cadastrais (nome, idade e cidade).
